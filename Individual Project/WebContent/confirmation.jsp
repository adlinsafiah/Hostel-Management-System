...
<div class="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="registerAlpha.jsp">Kolej Alpha</a>
...
<h1 style="text-align:center">We will send confirmation email along with room details to registered email if your application is successful.</h1>
<br>
<h1 style="text-align:center">Thank you and have a nice day!</h1>
<footer>
      <div class="container">
        <h4> Our Address</h4>
