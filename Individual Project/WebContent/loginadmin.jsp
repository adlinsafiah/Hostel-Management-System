...
<center>
<div class="wrapper">
    <form class="form-signin" action="adminpage.html" method="post">       
      ...
      <button class="btn btn-lg btn-primary btn-block" onClick="window.location.href='adminpage.html'" type="submit">Login</button>   
    </form>
  </div>
</center>
